...
var ExercicePromise = /** @class */ (function () {
    function ExercicePromise(CustomerService, CardService, CardBrandService) {
        this.CustomerService = CustomerService;
        this.CardService = CardService;
        this.CardBrandService = CardBrandService;
    }
    ExercicePromise.prototype.$onInit = function () {
        return __awaiter(this, void 0, void 0, function () { return __generator(this, function (_a) {
            return [2 /*return*/];
        }); });
    };
    return ExercicePromise;
}());
// ----
// ----
// ----
...
// ----
/** SERVICE DEFINITION */
var exo = new ExercicePromise(new CustomerService(), new CardService(), new CardBrandService());
exo.$onInit();
/** Reponse */
// ----
// ----
